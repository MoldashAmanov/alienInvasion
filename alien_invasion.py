...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        # Удаляет снаряды, вышедшие за экран
    ...
    def _create_fleet(self):
        ...
        while current_y < (self.settings.screen_height - 4 * alien_height):
            ...
            # Конец ряда, сбрасываем значене х и инкрементируем значение у
    ...
    def _update_aliens(self):
        ...
        # Проверить, сталкивается ли пришелец с нижник краем экрана
        self._check_aliens_bottom()

    def _ship_hit(self):
        """Обрабатывает столкновение корабля с пришельцем"""
        if self.stats.ship_left > 0:
            # Уменьшает ship_left и обновление панели
